...
const LessonButton = ({ id, index, totalCount, current, locked, percentage }: Props) => {
    ...
    return (
        <Link aria-disabled={locked} href={href} style={{ pointerEvents: locked ? "none" : "auto" }}>
            <div
                className="relative"
                style={{
            ...
            >
                {current ? (
                    <div className="h-[102px] w-[102px] relative">
                        <div className="absolute -top-6 left-2.5 px-3 py-2.5 border-2 font-bold uppercase text-sky-500
